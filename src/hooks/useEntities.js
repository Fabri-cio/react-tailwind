...
export const useSearchProducts = (search) => {
  return useData(ProductosAPI, "productos", null, { search }, 1000 * 60 * 5);
}
...
//inventarios
export const useSearchInventarios = (search) => {
  return useData(InventariosAPI, "inventarios", null, { search }, 1000 * 60 * 5);
}
