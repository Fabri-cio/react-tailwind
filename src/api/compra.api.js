...
export const ComprasListAPI = createCrudOperations(ApiCompras, "compras-list");
export const ComprasReporteAPI = createCrudOperations(ApiCompras, "compras-reportes");
