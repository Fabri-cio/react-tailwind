...
const getNavLinkClass = (isActive) =>
  `block px-4 py-2 rounded-lg transition-all duration-200 ${
    isActive ? "bg-blue-500 text-white" : "text-gray-300 hover:bg-blue-500"
  }`;
...
const SidebarMenu = ({ title, icon: Icon, items, isOpen, toggleMenu }) => (
  <li>
    ...
    <ActionButton
      label={title}
      estilos={`flex items-center w-full px-4 py-3 text-base font-semibold rounded-lg transition-all duration-300
