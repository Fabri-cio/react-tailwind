...
import { CustomUsersAPI } from "../../api/usuario.api"; // Importa la API adecuada
...
const UserEditPage = () => {
  ...
  useEffect(() => {
    ...
    const loadUserData = async () => {
      try {
        const response = await CustomUsersAPI.getOne(id); // Usar el método genérico para obtener el usuario por su ID
