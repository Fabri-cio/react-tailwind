...
const DetallesPredicciones = lazy(() =>
  import("../data/predicciones/detallesPredicciones/DetallesPrediccion")
);
export const prediccionesRoutes = [
  ...
  {
    path: "/detalles-predicciones/:id",
    element: <DetallesPredicciones />,
  },
];